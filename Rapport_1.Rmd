...
```{r echo=FALSE, message=FALSE,warning=FALSE,fig.pos='H', fig.height=4, fig.width=9, fig.align="center"}
library(ggmap)
register_google(key = "AIzaSyDR2ob6a6HSgsBhZkN -k0QNVeJT3uio4Wg") 
...
\newline
```{r echo=FALSE, message=FALSE,fig.pos='H', fig.height=5, fig.width=8, fig.align="center"}
library(gridExtra)
...
```{r echo=FALSE, message=FALSE, fig.pos='H', fig.height=4, fig.width=9, fig.align="center", warning=FALSE}
xmin <-  -122.4
xmax <-  -122
ymin <-  47.5
ymax <-  47.72
...
```{r, warning=F, echo = F, fig.height=4, fig.align="center"}
ggplot(donnees, aes(x=log(sqft_above), y = log(price), col = factor(expensive_area))) + 
    ...
    theme_bw() +
    theme(plot.title = element_text(hjust = 0.5, size = 6), axis.title = element_text(size=6), legend.position = "right")
```
