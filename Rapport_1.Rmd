...
La première qui a été créée est celle de l'âge de la maison (*age*). Initialement, le jeu de données permettait d'obtenir la date de vente de la maison grâce à la variable *date* et l'année de construction de la maison grâce à la variable *yr_built*. Avec l'aide de ces deux variables, il est donc facile d'obtenir l'âge de la maison, soit le nombre d'années depuis qu'elle a été construite avant la vente de celle-ci.

La deuxième variable qui a été créée est celle du nombre d'années depuis la dernière rénovation de la maison (*reno*). Cette variable a d'ailleurs été calculée de la même manière que l'âge de la maison décrite précédemment grâce à la date de vente de la maison de la variable *date* et l'année de rénovation de la maison de la variable *yr_renovated*. Par contre, étant donné le nombre élevé de maisons n'ayant jamais été rénové depuis leur construction dans le jeu de données initiales (20 699 comparativement à 914). Il a été décidé d'en faire une variable catégorielle ordinale. Soit une variable qui se divise en 3 sous-groupes, le premier étant *10 ans et moins* pour les maisons ayant eu une rénovation dans les 10 dernières années précédant leur vente, le deuxième étant *10 ans et plus* pour les maisons ayant eu une rénovation il y a 10 années ou plus et le dernier étant *Jamais rénové* pour les maisons n'ayant jamais été rénovées depuis leur construction.

La dernière variable créée est celle représentant la région la plus coûteuse (*expensive_area*). En effet, les variables réprésentant la latitude et la longitude sur la map monde de la maison indique en d'autres mots la position de la maison sur la planète Terre. En utilisant toutes ses données de position des maisons, il est alors facile de les situées sur une carte de la région de King County, la région à l'étude dans ce rapport. VOici d'ailleurs un aperçu des positions de chaque maison vendues à King County:
...
```
En regardant la **map** (bon mot?) affichée précédement, il est possible de voir qu'une bonne partie des maisons les plus couteuses se situe au nord-ouest de la map près de l'eau et ce qui semble être la zone urbaine en comparaison avec ce que nous pouvons voir de la map. Il est d'ailleurs possible d'identifier la région la plus couteuse en allant chercher les coordonnées des bonnes latitudes et longitudes.
...
```
La variable de la région la plus couteuse en est donc une catégorielle qui renvoie 1 lorsque la maison est située dans la région déterminée comme étant la plus couteuse et renvoie 0 lorsque la maison ne se situe pas dans la région la plus couteuse.
