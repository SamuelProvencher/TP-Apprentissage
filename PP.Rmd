...
varImpPlot(foret, main="Graphique X: Importance des variables composant \nla forêt aléatoire")
```
...
## Forêt aléatoire (suite)
```{r echo=FALSE, message=FALSE, warning=FALSE}
plot(int.lat) + ggtitle(" des statistiques H avec la latitude")+ theme_classic() + theme(plot.title = element_text(hjust = 0.5))
```
