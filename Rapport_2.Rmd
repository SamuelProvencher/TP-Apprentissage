...
```{r echo=FALSE, message=FALSE, warning=FALSE}
plot(pdp.lat.long) + ggtitle("Graphique X : Graphique de dépendance partielle bivarié \nentre la latitude et la longitude")+ theme_classic() + theme(plot.title = element_text(hjust = 0.35))
```
