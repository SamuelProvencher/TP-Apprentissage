...
\newline
\hypertarget{target1}{2.} Max Kuhn (2020). caret: Classification and Regression Training. R package version 6.0-85.
...
\newline
\hypertarget{target2}{7.} Jerome Friedman, Trevor Hastie, Robert Tibshirani (2010). Regularization Paths for Generalized Linear
