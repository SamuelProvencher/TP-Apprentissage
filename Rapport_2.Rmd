...
title(main="EQM selon le nombre d'itérations (d=7)", 
...
dataframe <- data.frame(c("Modèle de base", "Modèle Lasso", "K plus proches voisins","Arbre de décision","Bagging","Forêt aléatoire", "Boosting de gradient stochastique"), c(EQM.ModBase, msep.lasso, EQM.Kvoisins, EQM.arbre, EQM.bag, EQM.foret, EQM.gbm))
...
Nous observons que les valeurs les plus utiles dans le modèle de boosting sont *grade*, *lat*, *sqft_above*, *sqft_living15* et *long*. De plus, ces 5 variables les plus importantes sont les mêmes que celles du modèle de forêt aléatoire selon le même critère.
