...
dataframe <- data.frame(c("Modèle de base", "Modèle Lasso", "K voisins","Arbre","Bagging","Forêt aléatoire", "GBM"), c(EQM.ModBase,msep.lasso, EQM.Kvoisins, EQM.arbre, EQM.bag,EQM.foret,3))

kable(dataframe, caption = "Titre", col.names = c("Modèles","EQM"), digits = 5)
