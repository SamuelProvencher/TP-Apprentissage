...
plot(gbm.modele9, n.trees = n.iter9, i.var = "grade", main ="Graphique X : graphique de dépendance partielle \n de la variable grade")
```
...
plot(gbm.modele9, n.trees = n.iter9, i.var = "lat", main ="Graphique X : graphique de dépendance partielle \n de la variable lat")
```
...
plot(gbm.modele9, n.trees = n.iter9, i.var = "sqft_above", main = "Graphique X : graphique de dépendance partielle \n de la variable sqft_above")
```
...
ggplot(hstat.grade, aes(x = Variables, y = HStat)) + 
  ...
  coord_flip() +
  theme_bw() +
  labs(title = "Graphique X : graphique des statistiques H \n selon la variable grade") +
  ylab("Statistiques H") +
...
plot(gbm.modele9, i.var = c("grade", "lat"), n.trees = n.iter9, main = "Graphique X : Graphique de dépendance \npartielle bivarié entre les variables grade et lat")
```
...
plot(gbm.modele9, i.var = c("grade", "age"), n.trees = n.iter9, main = "Graphique X : Graphique de dépendance \npartielle bivarié entre les variables grade et age")
```
...
plot(gbm.modele9, i.var = c("long", "lat"), n.trees = n.iter9, main = "Graphique X : Graphique de dépendance \npartielle bivarié entre les variables long et lat")
```
