...
De 1, on choisit un échantillon bootstrap plus petit que le bagging, c'est pourquoi dans notre cas un `sampsize= 0.75*nrow(donnees.train)` a été choisi ce qui équivaut à utiliser 60% des données de l'échantillon d'entrainement. 
